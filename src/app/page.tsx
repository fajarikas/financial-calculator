          ...
          {showResults ? (
            ...
            <div className="text-center text-gray-500">
              <div id="empty-state" className="text-center py-8">
                <div
                  className="mx-auto w-20 h-20 bg-blue-100 rounded-full flex items-center justify-center mb-3 animate-bounce"
                >
                  <svg
                ...
                >Mulai Kelola Keuangan Anda</h3
                >
                <p className="text-gray-500 text-sm"
                >💡 Masukkan pendapatan bulanan Anda untuk melihat alokasinya.</p>
              </div>
            </div>
          )}
        </div>
